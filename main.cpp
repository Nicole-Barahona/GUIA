    ...
    do{
        ...
        switch(opc){
                ...
                if(contCuentas<TAM){
                    ...
                    if(contClientes==0){
                        ...
                        if(cliente){
                            ...
                            cout << "La cuenta fue agregada con exito\n";
                            contCuentas++;
                        }else{
            ...
            case 3:
                ///Hacer Abono
                    if(contCuentas==0){
                        cout << "No hay cuentas existentes\n";
                    }else{
                        ...
                        if(cuenta){
                            ...
                            cout << "El abono fue agregado con exito\n";
                            contAbono++;
                        }else{
            ...
            case 5:
                ///Mostras cuentas
                if(contCuentas==0){
                    cout << "No existen cuentas en el sistema\n";
                }else{
            ...
            case 7:
                ...
                break;
            default:
                cout << "Opcion no valida ingresar un numero dentro de las de opciones habilitadas\n";
                break;
        }
        system("pause");
    }while(opc!=7);
